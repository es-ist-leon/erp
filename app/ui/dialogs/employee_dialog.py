...
class EmployeeDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.employment_type.addItem("Vollzeit", "vollzeit")
        self.employment_type.addItem("Teilzeit", "teilzeit")
        self.employment_type.addItem("Ausbildung", "azubi")
        ...
        self.status.addItem("Urlaub/Abwesend", "on_leave")
